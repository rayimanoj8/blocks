...
// ** Icons **
import {
    Brush, Camera, ChartBarIncreasing, ChevronUp, CircleFadingPlus, CircleOff,
    CircleUserRound, File, Image, ListFilter, Menu, MessageCircle, MessageSquareDashed,
    MessageSquareDot, Mic, Paperclip, Phone, Search, Send, Settings, Smile, SquarePen,
    Star, User, User2, UserRound, Users, Video
} from "lucide-react";
                        ...
                        <SidebarMenuItem>
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent side="top" className="w-[--radix-popper-anchor-width]">
                                    <DropdownMenuItem><a href="https://github.com/rayimanoj8/">Account</a></DropdownMenuItem>
                                    <DropdownMenuItem><span>Back Up</span></DropdownMenuItem>
                                ...
                                <div className="flex justify-end w-full">
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent className="w-56">
                                            ...
                                            <DropdownMenuGroup>
                                                <DropdownMenuItem><MessageSquareDot /> Unread</DropdownMenuItem>
                                                <DropdownMenuItem><Star /> Favorites</DropdownMenuItem>
                                                <DropdownMenuItem><CircleUserRound /> Contacts</DropdownMenuItem>
                                                <DropdownMenuItem><CircleOff /> Non Contacts</DropdownMenuItem>
                                            </DropdownMenuGroup>
                                            <DropdownMenuSeparator />
                                            <DropdownMenuGroup>
                                                <DropdownMenuItem><Users /> Groups</DropdownMenuItem>
                                                <DropdownMenuItem><MessageSquareDashed /> Drafts</DropdownMenuItem>
                                            </DropdownMenuGroup>
                                        </DropdownMenuContent>
                                    </DropdownMenu>
                                </div>
                        ...
                        <div className="flex flex-col justify-between h-screen ml-1 pb-2">
                            ...
                            <div className="h-16 border-b flex items-center px-3">
                                ...
                                <div className="flex-grow flex justify-end gap-2">
                                    <Button type="icon" variant="ghost"><Video /></Button>
                                    <Button type="icon" variant="ghost"><Phone /></Button>
                                    <Button type="icon" variant="ghost"><Search /></Button>
                                </div>
                            </div>
                            ...
                            <div className="flex h-10 pt-2 border-t">
                                ...
                                <Input className="flex-grow border-0" placeholder="Type a message" />
